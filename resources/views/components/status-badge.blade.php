...
@php
$config = match($status) {
    'berkas_diterima'    => ['label' => 'Berkas Diterima',    'class' => 'bg-blue-50 text-blue-700 ring-blue-600/20'],
    ...
    'ditolak_kecamatan'  => ['label' => 'Ditolak Kecamatan',  'class' => 'bg-orange-50 text-orange-700 ring-orange-600/20'],
    'diproses_kecamatan' => ['label' => 'Diproses Kecamatan', 'class' => 'bg-purple-50 text-purple-700 ring-purple-600/20'],
