<x-dashboard-layout title="Riwayat Pengajuan" pageTitle="Riwayat Pengajuan">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('admin.riwayat') }}" class="flex flex-wrap gap-3 items-end">
            <div>
            ...
            <div>
                ...
                <select name="desa" class="text-sm border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500">
            ...
            <div class="flex gap-2">
                ...
                @if(request()->hasAny(['status', 'jenis_layanan', 'desa', 'tanggal_dari', 'tanggal_sampai', 'nik']))
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Desa</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-500">{{ $p->desa ?? $p->user->desa ?? '-' }}</td>
                            <td class="px-6 py-4">
